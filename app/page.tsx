...
function AdminHomePage({ user }: { user: User }) {
  const adminFeatures = [
    ...
    },
    {
      ...
      description: "Create, edit, and monitor all community events.",
      href: "/admin",
      color: "text-green-600",
    },
    {
    ...
    <div className="min-h-screen bg-gradient-to-br from-red-50 to-orange-100">
      ...
      <section className="relative py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <h1 className="text-4xl md:text-6xl font-bold text-gray-900 mb-6">
            Welcome back,
            <span className="text-red-600"> {user.firstName}!</span>
          </h1>
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
            Manage the SKConnect platform, oversee user activities, and ensure smooth operation
            of all community engagement features.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/admin">
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600">Quick access to key administrative functions</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-red-600">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">System Administration</h2>
          <p className="text-xl text-red-100 mb-8">
            You have full administrative access to manage users, events, and system settings.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/admin">
              <Button size="lg" variant="secondary" className="w-full sm:w-auto">
